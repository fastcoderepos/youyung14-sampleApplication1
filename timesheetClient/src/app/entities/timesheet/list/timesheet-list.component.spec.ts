...
import { ITimesheet, TimesheetService, TimesheetDetailsComponent, TimesheetListComponent,
	TimesheetNewComponent } from '../';
...
describe('TimesheetListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/timesheet/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
