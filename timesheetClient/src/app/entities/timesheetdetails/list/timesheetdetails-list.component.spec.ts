...
import { ITimesheetdetails, TimesheetdetailsService, TimesheetdetailsDetailsComponent, TimesheetdetailsListComponent,
	TimesheetdetailsNewComponent } from '../';
...
describe('TimesheetdetailsListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/timesheetdetails/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
