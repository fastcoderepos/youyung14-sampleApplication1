...
import { UsertaskExtendedService, UsertaskDetailsExtendedComponent, UsertaskListExtendedComponent, UsertaskNewExtendedComponent } from './';
...
const entities = [
    UsertaskDetailsExtendedComponent, UsertaskListExtendedComponent, UsertaskNewExtendedComponent 
  ]
@NgModule({
