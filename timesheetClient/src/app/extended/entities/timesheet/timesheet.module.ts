...
import { TimesheetExtendedService, TimesheetDetailsExtendedComponent, TimesheetListExtendedComponent, TimesheetNewExtendedComponent } from './';
...
const entities = [
    TimesheetDetailsExtendedComponent, TimesheetListExtendedComponent, TimesheetNewExtendedComponent 
  ]
@NgModule({
