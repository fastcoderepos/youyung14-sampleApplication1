...
import { ProjectExtendedService, ProjectDetailsExtendedComponent, ProjectListExtendedComponent, ProjectNewExtendedComponent } from './';
...
const entities = [
    ProjectDetailsExtendedComponent, ProjectListExtendedComponent, ProjectNewExtendedComponent 
  ]
@NgModule({
