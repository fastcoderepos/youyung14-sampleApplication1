...
import { TaskExtendedService, TaskDetailsExtendedComponent, TaskListExtendedComponent, TaskNewExtendedComponent } from './';
...
const entities = [
    TaskDetailsExtendedComponent, TaskListExtendedComponent, TaskNewExtendedComponent 
  ]
@NgModule({
