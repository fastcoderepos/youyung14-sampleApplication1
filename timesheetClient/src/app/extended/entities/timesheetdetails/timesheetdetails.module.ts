...
import { TimesheetdetailsExtendedService, TimesheetdetailsDetailsExtendedComponent, TimesheetdetailsListExtendedComponent, TimesheetdetailsNewExtendedComponent } from './';
...
const entities = [
    TimesheetdetailsDetailsExtendedComponent, TimesheetdetailsListExtendedComponent, TimesheetdetailsNewExtendedComponent 
  ]
@NgModule({
