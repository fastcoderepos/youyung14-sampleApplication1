...
import { TimesheetstatusExtendedService, TimesheetstatusDetailsExtendedComponent, TimesheetstatusListExtendedComponent, TimesheetstatusNewExtendedComponent } from './';
...
const entities = [
    TimesheetstatusDetailsExtendedComponent, TimesheetstatusListExtendedComponent, TimesheetstatusNewExtendedComponent 
  ]
@NgModule({
