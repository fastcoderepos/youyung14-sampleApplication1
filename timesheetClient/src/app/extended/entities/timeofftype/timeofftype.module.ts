...
import { TimeofftypeExtendedService, TimeofftypeDetailsExtendedComponent, TimeofftypeListExtendedComponent, TimeofftypeNewExtendedComponent } from './';
...
const entities = [
    TimeofftypeDetailsExtendedComponent, TimeofftypeListExtendedComponent, TimeofftypeNewExtendedComponent 
  ]
@NgModule({
