...
import com.fastcode.timesheet.addons.reporting.domain.permalink.IPermalinkRepository;
import com.fastcode.timesheet.addons.reporting.domain.permalink.QPermalink;
...
public class PermalinkAppService implements IPermalinkAppService {
	...
	public BooleanBuilder searchKeyValuePair(QPermalink permalink, Map<String,SearchFields> map,Map<String,String> joinColumns) {
